...
from data.dataset_delete import get_ids, transform_dataset,get_subject_label
from data.get_y import get_y
...
import logging
from train_and_eval import train_and_evaluate,evaluate,plot3
...
def main(args):
    ...
    plot3(model, device, loader1, loader2)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--drop_rate_fcn', type=float, default=0.6)
